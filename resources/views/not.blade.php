                    ...
                    <div class="box-body p-0">
                        <div class="p-3 d-flex align-items-center bg-light border-bottom osahan-post-header">
                            ...
                            <div class="font-weight-bold mr-3">
                                ...
                                <div class="small">Income tax sops on the cards, The bias in VC funding, and other top news
                                    for you</div>
                            </div>
                ...
                {{-- <div class="box shadow-sm rounded bg-white mb-3">
                    ...
                    <div class="box-body p-0">
                        ...
                        <div class="p-3 d-flex align-items-center border-bottom osahan-post-header">
                            ...
                            <div class="font-weight-bold mr-3">
                                <div>
                                    <span class="font-weight-normal">Congratulate Mnadeep singh (iamgurdeeposahan)</span>
                                    for 4 years at Askbootsrap Pvt.
                                    <div class="small text-success"><i class="fa fa-check-circle"></i> You sent Mandeep a
                                        message</div>
                                </div>
                            </div>
                            <span class="ml-auto mb-auto">
